local hyperKey = { "shift", "cmd", "alt", "ctrl" }
...
hs.hotkey.bind(hyperKey, "m", toggle_window_full_screen)

-- local switcher = hs.window.switcher.new(hs.window.filter.new():setCurrentSpace(true):setDefaultFilter({}))

-- hs.hotkey.bind(hyperKe, "m", "Next window", function()
-- 	switcher:next()
-- end)
