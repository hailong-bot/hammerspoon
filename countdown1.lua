...
local function showCurrentTime()
	...
	hs.alert.show(prettyNow, hs.alert.defaultStyle, hs.screen.mainScreen(), 2)
end

hs.hotkey.bind(Common.hyperKey, "C", showCurrentTime)

-- Set a hotkey to get the remaining time of the timer
hs.hotkey.bind(Common.hyperKey, "R", getRemainTime)

-- Set a hotkey to start the timer
hs.hotkey.bind(Common.hyperKey, "I", startRemindTimer)

-- Set a hotkey to stop the timer
hs.hotkey.bind(Common.hyperKey, "S", stopRemindTimer)
